...
int main(int argc,char *argv[])
{
    ...
    string filename; 
    filename  = "non_compressed_text.txt";                                                                                //Set filename
    ...
    string filenameCompr;                                                                                //Set filename
    filenameCompr = "compressed_text.txt";
   // cout << "Enter Filename:\t";
   // cin >> filenameCompr;
    ofstream output_file((filenameCompr +".huf").c_str(),ios::binary);                              //Write file name
