...
{
    std::ofstream writeEncodeTo("C://compressed_text.txt");
    ...
    for(int i=0; stringToEncode[i]!='\0'; i++)
    {
        ...
        writeEncodeTo<<traversal->code;
    }

    printf("\n");
    writeEncodeTo<<std::endl;
    writeEncodeTo.close();
}

void decode(htTree *tree, char *stringToDecode)
{
    std::ofstream writeDecodeTextTo("C://Compare_decompressed_text.txt");
    ...
    for(int i=0; stringToDecode[i]!='\0'; i++)
    {
        if(traversal->left == NULL && traversal->right == NULL)
        {
            ...
            writeDecodeTextTo<<traversal->symbol;
            traversal = tree->root;
        }
    ...
    {
        printf("%c",traversal->symbol);
        writeDecodeText<<traversal->symbol;
        traversal = tree->root;
    }
    */

    printf("\n");
    //writeDecodeText<<std::endl;
    writeDecodeTextTo.close();
}
